...
(function () {
    ...
    if (document.getElementsByClassName("login-control")[0].style.display == "none") {
        ...
        buttonx5A.style.display = "none";

        // 新校区图书馆5楼A区的座位配置（仅有电无主机座位）
        ...
        buttonx5A1.style.display = "none";

        // 本部图书馆2楼B区的座位配置（仅有电座位）
        ...
        // buttonb2B.style.display = "none";

        // 本部图书馆2楼B区的座位配置（雷安宾专用）
        var buttonb2B1 = document.createElement("button");
        buttonb2B1.innerHTML = "本部二楼B区lab";
        buttonb2B1.className = "btn btn-default";
        buttonb2B1.setAttribute("data-toggle", "tooltip");
        buttonb2B1.setAttribute("data-placement", "right");
        buttonb2B1.title = "预配置本部二楼B区抢座</br>雷安宾专用</br>立即开抢";
        // buttonb2B1.style.display = "block";
        buttonb2B1.style.display = "none";
        ...
        tempdiv.appendChild(buttonb2B1);
    ...
    buttonb2B1.onclick = function () {
        ...
        while(laborder2 != 0){
            for(i = 0; i < 6; i += 1){
                ownlike.push(laborder1);
                laborder1 -= 1;
            }
            for(i = 0; i < 6; i += 1){
                ownlike.push(laborder2);
                laborder2 -= 1;
            }
        }
